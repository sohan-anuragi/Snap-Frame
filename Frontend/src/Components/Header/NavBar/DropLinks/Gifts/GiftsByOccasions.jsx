...
import { byOccasionsItems } from "./ByOccasionsData";

export default function GiftsByOccasions() {
  const [byOccasionsOpen, setByOccasionsOpen] = useState(false);

  return (
    <>
      <li
        className={`
              ${byOccasionsOpen === true ? "" : "hover:bg-gray-100"}
    relative px-2
    pl-6 py-3
