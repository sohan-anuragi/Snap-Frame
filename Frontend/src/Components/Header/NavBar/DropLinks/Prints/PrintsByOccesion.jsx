...
import { occasionItems } from "./PrintData";

export default function PrintsByOccesion({ occasionOpen, setOccasionOpen }) {
  return (
    <>
      <li
        className={`
              ${occasionOpen === true ? "" : "hover:bg-gray-100"}
    relative px-2
    pl-6 py-3
  ...
  `}
      >
        ...
        >
          <span className="font-bold  text-[#000000a2]">By Occasion</span>
