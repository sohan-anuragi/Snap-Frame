  ...
  return (
    <>
      ...
      <div className="w-full  flex flex-col md:flex-row bg-white  flex items-start !p-[2rem] !pb-[0rem] justify-between gap-[2%]">
        ...
        {/* Promo Banner */}
        <div className=" flex items-center justify-center border-dashed border-[1px] border-[#f3d8d8] gap-[1%] mt-[1rem] md:mt-[0rem] bg-[#f9f9b8]  px-[1rem] py-[1rem] max-h-[40px] ">
          <div className="flex  gap-[0.3rem] flex-1">
            {/* Main Text */}
            ...
            <span className="text-black font-normal text-[0.7rem] leading-tight">
              <span className="font-bold text-red-600">
                Extra 5% OFF on Custom Neck Pillow{" "}
              </span>
              | USE CODE: TRAVELPILLOW
            </span>
          </div>
        </div>
      </div>
