...
import travelPillowImg from "./Component2Img/pp-6.jpg";

export default function Component2Copy6() {
  return (
    <div className="w-full py-12 px-4 md:px-8 ">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-8 md:gap-12">
        {/* Left Side - Image */}
        ...
        <div className="w-full md:w-1/2 space-y-6">
          ...
          <h2 className="text-[1.4rem] font-bold  font-sans">
            A Perfect Indoor Hobby and Here’s Why: A Perfect Indoor Hobby and
            Here’s Why:
          </h2>
